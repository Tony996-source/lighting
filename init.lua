...
minetest.register_node("lighting:blue_lantern_f", {
  ...
  on_place = function(itemstack, placer, pointed_thing)
      ...
      vector.subtract(pointed_thing.under, pointed_thing.above))
		...
		if wdir == 0 then
			fakestack:set_name("lighting:blue_lantern_c")
		elseif wdir == 1 then
			fakestack:set_name("lighting:blue_lantern_f")
		else
			fakestack:set_name("lighting:blue_lantern_w")
		end

		itemstack = minetest.item_place(fakestack, placer, pointed_thing, wdir)
		itemstack:set_name("lighting:blue_lantern_f")

		return itemstack
	end,
})

minetest.register_node("lighting:blue_lantern_c", {
  drawtype = "mesh",
  ...
  groups = {cracky = 2, oddly_breakable_by_hand = 3,
    not_in_creative_inventory = 1},
  sounds = default.node_sound_glass_defaults(),
  drop = "lighting:blue_lantern_f",
})

minetest.register_node("lighting:blue_lantern_w", {
  drawtype = "mesh",
...
minetest.register_node("lighting:lantern_f", {
  ...
  on_place = function(itemstack, placer, pointed_thing)
      ...
      vector.subtract(pointed_thing.under, pointed_thing.above))
		...
		if wdir == 0 then
			fakestack:set_name("lighting:lantern_c")
		elseif wdir == 1 then
			fakestack:set_name("lighting:lantern_f")
		else
			fakestack:set_name("lighting:lantern_w")
		end
...
minetest.register_node("lighting:lantern_c", {
  drawtype = "mesh",
  mesh = "lantern_c.obj",
  tiles = {"orange_lantern.png", "metal_dark_32.png"},
  collision_box = {
  ...
  groups = {cracky = 2, oddly_breakable_by_hand = 3,
    not_in_creative_inventory = 1},
  sounds = default.node_sound_glass_defaults(),
  drop = "lighting:lantern_f",
})

minetest.register_node("lighting:lantern_w", {
  drawtype = "mesh",
  mesh = "lantern_w.obj",
  tiles = {"orange_lantern.png", "metal_dark_32.png"},
  collision_box = {
